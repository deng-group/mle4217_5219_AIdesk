...
- 2. `database/materials_project.ipynb_0` | `database/materials_project.ipynb` | score=1.555
- 3. `database/materials_project.ipynb_3` | `database/materials_project.ipynb` | score=1.508
...
- 2. `computer/hpc.md_0` | `computer/hpc.md` | score=0.804
- 3. `orientation/introduction.md_0` | `orientation/introduction.md` | score=0.706
